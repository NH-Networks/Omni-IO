(function () {
    function createElements() {
        return {
            ...
            sunFacadeAzimuthInput: document.getElementById("sun-facade-azimuth"),
            sunUseIncidenceInput: document.getElementById("sun-use-incidence"),
            ...
            sunMinHoldInput: document.getElementById("sun-min-hold"),
            sunRainEnabledInput: document.getElementById("sun-rain-enabled"),
            sunRainActionSelect: document.getElementById("sun-rain-action"),
            sunRainLockoutInput: document.getElementById("sun-rain-lockout"),
            sunMaxWindInput: document.getElementById("sun-max-wind"),
            sunMaxWindGustInput: document.getElementById("sun-max-wind-gust"),
            sunWindActionSelect: document.getElementById("sun-wind-action"),
            sunWindLockoutInput: document.getElementById("sun-wind-lockout"),
            sunTempFilterEnabledInput: document.getElementById("sun-temp-filter-enabled"),
            sunMinTempInput: document.getElementById("sun-min-temp"),
            sunHotdayEnabledInput: document.getElementById("sun-hotday-enabled"),
            sunHotdayTempInput: document.getElementById("sun-hotday-temp"),
            ...
            sunMetricEffective: document.getElementById("sun-metric-effective"),
            ...
            sunMetricRain: document.getElementById("sun-metric-rain"),
